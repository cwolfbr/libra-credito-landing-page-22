        ...
        <div className="container mx-auto px-6 py-1.5">
          <div className="flex items-center justify-center">
            <div className="flex items-center text-white text-xs font-medium">
              <Shield className="w-3 h-3 mr-1.5 text-libra-gold" />
        ...
        <div className="container mx-auto px-6 py-2.5">
          <div className="flex items-center justify-between">
            ...
            <Link to="/" className="flex items-center gap-2 group" aria-label="Página inicial da Libra Crédito">
              <div className="w-8 h-8 bg-gradient-to-br from-libra-navy to-libra-blue rounded-lg flex items-center justify-center shadow-md group-hover:shadow-lg transition-all duration-300">
                <span className="text-white font-bold text-sm">L</span>
              </div>
              <div className="flex flex-col">
                <span className="text-libra-navy font-bold text-xl tracking-tight">Libra Crédito</span>
                <span className="text-libra-gold text-xs font-medium">Vem que a gente equiLIBRA</span>
              </div>
            </Link>
            ...
            <div className="flex items-center gap-3">
              <Button
                ...
                className="border-libra-navy text-libra-navy hover:bg-libra-navy hover:text-white transition-all duration-200 text-xs px-4 py-1.5 h-8"
              >
                Portal de Clientes
              </Button>
              ...
              <Button 
                ...
                className="bg-gradient-to-r from-libra-gold to-yellow-400 hover:from-yellow-400 hover:to-libra-gold text-black font-bold px-6 py-1.5 rounded-full shadow-md hover:shadow-lg transition-all duration-200 hover:scale-105 text-sm h-8"
