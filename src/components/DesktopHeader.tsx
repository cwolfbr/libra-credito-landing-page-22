...
const DesktopHeader: React.FC<DesktopHeaderProps> = ({ onPortalClientes, onSimulateNow }) => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-white shadow-sm" role="banner">
      {/* Barra de informação superior - minimalista */}
      <div className="bg-gray-50 border-b border-gray-100">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-center py-1">
            <div className="flex items-center text-libra-navy text-xs">
          ...
          <div className="flex items-center justify-between h-12">
            ...
            <Link to="/" className="flex items-center gap-2 group" aria-label="Página inicial da Libra Crédito">
              ...
              <div className="flex flex-col">
                <span className="text-libra-navy font-bold text-base tracking-tight leading-tight">Libra Crédito</span>
            ...
            <nav className="flex items-center space-x-6">
              {navigationItems.map((item) => (
                <Link
                  key={item.path}
                  to={item.path}
                  className={`relative text-sm font-medium transition-all duration-200 hover:text-libra-blue ${
            ...
            <div className="flex items-center gap-2">
              <Button
                ...
                className="border-libra-navy text-libra-navy hover:bg-libra-navy hover:text-white transition-all duration-200 text-xs h-8 px-3"
              >
                Portal de Clientes
              </Button>
              ...
              <Button 
                ...
                className="px-3 text-xs font-bold shadow-lg hover:shadow-xl transition-all duration-200 hover:-translate-y-0.5 h-8"
              >
                Simule Agora
              </Button>
            </div>
