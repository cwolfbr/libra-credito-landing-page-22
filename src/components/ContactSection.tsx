        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    className="bg-libra-navy/30 border-libra-blue/30 text-white placeholder:text-gray-400"
                  />
                </div>
                <div>
              ...
              <Button 
                type="submit" 
                className="w-full bg-libra-gold hover:bg-white hover:text-libra-navy text-libra-navy font-semibold"
              >
                Enviar Mensagem
              </Button>
            </form>
