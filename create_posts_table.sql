-- Criar tabela blog_posts para o blog
...
COMMENT ON TABLE blog_posts IS 'Tabela para armazenar posts do blog da Libra Crédito';
COMMENT ON COLUMN blog_posts.id IS 'ID único do post (UUID)';
COMMENT ON COLUMN blog_posts.title IS 'Título do post';
COMMENT ON COLUMN blog_posts.description IS 'Descrição/resumo do post';
COMMENT ON COLUMN blog_posts.category IS 'Categoria do post (home-equity, cgi, etc.)';
COMMENT ON COLUMN blog_posts.image_url IS 'URL da imagem de capa do post';
COMMENT ON COLUMN blog_posts.slug IS 'Slug único para URL amigável';
COMMENT ON COLUMN blog_posts.content IS 'Conteúdo completo do post em HTML/Markdown';
COMMENT ON COLUMN blog_posts.read_time IS 'Tempo estimado de leitura em minutos';
COMMENT ON COLUMN blog_posts.published IS 'Se o post está publicado ou é rascunho';
COMMENT ON COLUMN blog_posts.featured_post IS 'Se o post é destacado/featured';
COMMENT ON COLUMN blog_posts.meta_title IS 'Título para SEO';
COMMENT ON COLUMN blog_posts.meta_description IS 'Descrição para SEO';
